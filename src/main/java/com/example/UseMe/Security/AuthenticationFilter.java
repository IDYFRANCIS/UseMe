package com.example.UseMe.Security;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        try {
            ...
            if (resourcePath.contains("/api-docs") || resourcePath.contains("/actuator") || resourcePath.contains("/health") || resourcePath.contains("/swagger-ui.html") || resourcePath.contains("/webjars") || resourcePath.equalsIgnoreCase("/api/v1")
                || resourcePath.contains("/swagger-resources") || resourcePath.contains("/docs") || resourcePath.contains("/user") || resourcePath.contains("/car") || resourcePath.contains("/carOwner") || resourcePath.contains("/carRenter")) {
